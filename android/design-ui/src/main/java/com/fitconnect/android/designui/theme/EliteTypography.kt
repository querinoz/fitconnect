 ...
 *
 * Every Material3 slot is mapped so screens never fall back to platform Roboto.
 */
...
val EliteTypographyStyles = Typography(
    ...
    displaySmall = style(T.HEADLINE_SIZE_SP, T.HEADLINE_LINE_HEIGHT_SP, T.HEADLINE_WEIGHT, T.HEADLINE_TRACKING, T.HEADLINE_FAMILY),
    headlineLarge = style(T.DISPLAY_L_SIZE_SP, T.DISPLAY_L_LINE_HEIGHT_SP, T.DISPLAY_L_WEIGHT, T.DISPLAY_L_TRACKING, T.DISPLAY_L_FAMILY),
    ...
    headlineSmall = style(T.TITLE_SIZE_SP, T.TITLE_LINE_HEIGHT_SP, T.TITLE_WEIGHT, T.TITLE_TRACKING, T.TITLE_FAMILY),
    ...
    titleSmall = style(T.CAPTION_SIZE_SP, T.CAPTION_LINE_HEIGHT_SP, T.CAPTION_WEIGHT, T.CAPTION_TRACKING, T.CAPTION_FAMILY),
    ...
    bodySmall = style(T.CAPTION_SIZE_SP, T.CAPTION_LINE_HEIGHT_SP, T.BODY_WEIGHT, T.CAPTION_TRACKING, T.BODY_FAMILY),
    labelLarge = style(T.CAPTION_SIZE_SP, T.CAPTION_LINE_HEIGHT_SP, T.CAPTION_WEIGHT, T.CAPTION_TRACKING, T.CAPTION_FAMILY),
    labelMedium = style(T.OVERLINE_SIZE_SP, T.OVERLINE_LINE_HEIGHT_SP, T.OVERLINE_WEIGHT, T.OVERLINE_TRACKING, T.OVERLINE_FAMILY),
