...
object DefaultSportsCatalog {
    ...
    fun definitions(): List<SportDefinition> = listOf(
        ...
        sport(
            ...
            wearables = setOf(WearableCapability.HEART_RATE, WearableCapability.HEALTH_CONNECT, WearableCapability.WEAR_OS),
            ...
            capabilities = setOf("zenith_v85_train_core"),
        ),
        sport(
            id = SportId.GYM,
            name = "Gym",
        ...
        sport(
            ...
            part = ParticipationKind.BOTH,
            strava = "Workout",
            equipment = listOf("Sled", "Wall ball", "Rower"),
            required = listOf(
                m("total_time", "Total Time", "min", MetricValueType.DURATION),
                m("station_time", "Station Time", "s", MetricValueType.DURATION),
            ),
            optional = listOf(m("run_split", "Run Split", "min", MetricValueType.DURATION)),
            performance = listOf("total_time", "station_time"),
            recovery = listOf("hrv", "soreness"),
            risk = listOf("fatigue", "form_breakdown"),
            wearables = setOf(WearableCapability.HEART_RATE, WearableCapability.HEALTH_CONNECT, WearableCapability.WEAR_OS),
            training = setOf(TrainingType.INTERVAL, TrainingType.STRENGTH, TrainingType.ENDURANCE, TrainingType.MIXED),
            competition = setOf(CompetitionType.RACE, CompetitionType.PERSONAL_CHALLENGE),
            capabilities = setOf("zenith_v85_train_core", "hybrid_race"),
        ),
        sport(
            id = SportId.GENERAL_FITNESS,
            ...
            optional = listOf(m("rpe", "RPE", "", MetricValueType.SCORE)),
            performance = listOf("duration", "consistency"),
            recovery = listOf("hrv", "sleep"),
            risk = listOf("fatigue"),
            wearables = setOf(WearableCapability.HEALTH_CONNECT, WearableCapability.WEAR_OS, WearableCapability.HEART_RATE),
            training = setOf(TrainingType.MIXED, TrainingType.MOBILITY, TrainingType.RECOVERY),
            competition = setOf(CompetitionType.PERSONAL_CHALLENGE),
            capabilities = setOf("zenith_v85_train_core", "fallback"),
        ),
        sport(
