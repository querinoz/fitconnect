...
object CommunitySeed {
    ...
    private fun worldFeed(now: Long): List<PostDraft> {
        ...
        return listOf(
            ...
            PostDraft(
                ...
                shareTelemetryFacts = true,
                media = img("m-gym-1", "fc_feed_post_1"),
                skipRateLimit = true,
            ...
            PostDraft(
                ...
                sportKey = "strength_training",
                media = img("m-gym-2", "fc_feed_post_2"),
                skipRateLimit = true,
    ...
    private val world = listOf(
        ...
        UserProfile("a1", "alex.fit", CommunityRole.ATHLETE, sportKeys = listOf("running"), bio = "Dawn miles. City loops.", avatarUri = "fc_story_alex"),
        UserProfile("a2", "king_kai", CommunityRole.ATHLETE, sportKeys = listOf("cycling"), bio = "Ridges and long days.", avatarUri = "fc_story_kai"),
        UserProfile("a3", "train.with.em", CommunityRole.ATHLETE, sportKeys = listOf("swimming"), bio = "Black-water kilometres.", avatarUri = "fc_story_em"),
        UserProfile("a4", "lucas.mvmt", CommunityRole.ATHLETE, sportKeys = listOf("strength_training"), bio = "Iron, chalk, quiet.", avatarUri = "fc_story_lucas"),
