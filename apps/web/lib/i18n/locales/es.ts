export const es = {
  ...
  landingV2: {
    ...
    map: {
      ...
      body: "Los tiles OpenFreeMap cargan en tiempo real. Las rutas y el atleta en movimiento son LOCAL_DEMO — no GPS de hardware hasta que conectes Strava.",
      locate: "Mi posición",
      you: "Tú"
    }
  },
  landingEditorial: {
    ...
    heroElite: {
      navOverview: "VISTA DEL OS",
      navTelemetry: "TELEMETRÍA",
      navManifesto: "MANIFIESTO",
      navInitialize: "INICIAR",
      headlineLine1: "Entrena con",
      headlineLine2: "datos en vivo.",
      subtitle:
        "FitConnect conecta coaches especialistas verificados con readiness en tiempo real, telemetría wearable y feedback de sesión — cada decisión de entrenamiento tiene una señal detrás.",
      ctaPrimary: "Encontrar coach",
      ctaSecondary: "Ver el OS",
      statCoaches: "318",
      statCoachesLabel: "coaches verificados · LOCAL DEMO",
      statRating: "4,94",
      statRatingLabel: "valoración de atletas",
      statRejected: "62%",
      statRejectedLabel: "solicitudes rechazadas",
      liveSession: "Sesión en vivo",
      liveSessionTitle: "Recalibración de umbral",
      liveBadge: "En vivo",
      telemetryHrv: "HRV",
      telemetryLoad: "Carga",
      telemetrySleep: "Sueño",
      coachAction: "Acción del coach",
      coachActionBody: "Diego cortó el intervalo final cuando el drift de FC superó la línea base.",
      readinessIndex: "ÍNDICE_READINESS",
      coachSignal: "SEÑAL_COACH",
      coachSignalBadge: "AJUSTADO",
      coachSignalValue: "4,2",
      coachSignalUnit: "% caída de carga"
    },
    sectionBreak: {
      connect: "CONECTA",
      perform: "PERFORMA",
  ...
  commandPalette: {
    ...
    actions: "Acciones",
    openDemo: "Abrir panel demo",
    goDashboard: "Ir al dashboard",
    goSessions: "Ir a sesiones",
    goDiscover: "Descubrir coaches",
    goSettings: "Ajustes de apariencia",
    goRoster: "Plantilla de atletas",
    hint: "⌘K para abrir"
  },
  mobileApp: {
    launcher: {
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Programas de marca de coaches destacados. Los conteos de completado se publican cuando haya datos de producción."
      },
      {
  ...
  faqs: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Future y Caliber te emparejan con un coach generalista interno. FitConnect es un marketplace de especialistas verificados en 10 deportes — yoga, surf, BJJ, escalada — que plataformas como Future simplemente no cubren. Obtienes la responsabilidad humana que ofrecen, más expertise deportiva real."
      },
      {
  ...
  dashboard: {
    ...
    noAthleteProfile:
      "Todavía no hay perfil de atleta en esta cuenta. Completa el onboarding o conecta un wearable.",
    os: {
  ...
  auth: {
    ...
    usernamePlaceholder: "tú@ejemplo.com",
    ...
    bullets: [
      "Una cuenta — Atleta y Coach son modos de la misma sesión",
      "Feed, Ascend, TRAIN, Dashboard, Perfil — un sistema operativo",
      "Recuperación solo con tus datos. Nunca inventamos HRV ni sueño"
    ],
    demoBullets: [
  ...
  discover: {
    ...
    loading: "Cargando vistas editoriales…",
    matchCount: "{count} especialistas en esta vista editorial coinciden con tus filtros",
