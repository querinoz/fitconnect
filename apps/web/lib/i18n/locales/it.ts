export const it = {
  ...
  hero: {
    livePill: "Live · specialisti verificati in 10 sport",
    ...
    immersive: {
      ...
      immersiveAccent: "la performance umana",
  ...
  landingV2: {
    ...
    map: {
      ...
      body: "I tile OpenFreeMap si caricano in tempo reale. Tracce e atleta in movimento sono LOCAL_DEMO — non GPS hardware finché non colleghi Strava.",
      locate: "Trovami",
      you: "Tu"
    }
  },
  landingEditorial: {
    ...
    hero: {
      ...
      statRating: "4.94★",
      statRatingLabel: "VALUTAZIONE"
    },
    heroElite: {
      navOverview: "PANORAMICA OS",
      navTelemetry: "TELEMETRIA",
      navManifesto: "MANIFESTO",
      navInitialize: "AVVIA",
      headlineLine1: "Allenati con",
      headlineLine2: "dati live.",
      subtitle:
        "FitConnect collega coach specialisti verificati a readiness in tempo reale, telemetria wearable e feedback di sessione — ogni decisione di allenamento ha un segnale.",
      ctaPrimary: "Trova coach",
      ctaSecondary: "Guarda l'OS",
      statCoaches: "318",
      statCoachesLabel: "coach verificati · LOCAL DEMO",
      statRating: "4,94",
      statRatingLabel: "valutazione atleti",
      statRejected: "62%",
      statRejectedLabel: "candidati rifiutati",
      liveSession: "Sessione live",
      liveSessionTitle: "Ricalibrazione soglia",
      liveBadge: "Live",
      telemetryHrv: "HRV",
      telemetryLoad: "Carico",
      telemetrySleep: "Sonno",
      coachAction: "Azione coach",
      coachActionBody: "Diego ha tagliato l'ultimo intervallo quando il drift FC ha superato la baseline.",
      readinessIndex: "INDICE_READINESS",
      coachSignal: "SEGNALE_COACH",
      coachSignalBadge: "REGOLATO",
      coachSignalValue: "4,2",
      coachSignalUnit: "% calo carico"
    },
    sectionBreak: {
      connect: "CONNETTI",
      perform: "PERFORMA",
  ...
  trustStrip: {
    ...
    coaches: "Coach verificati nel marketplace"
  },
  featuredCoaches: {
  ...
  dashboard: {
    ...
    noAthleteProfile:
      "Nessun profilo atleta è ancora collegato a questo account. Completa l'onboarding o collega un wearable.",
    os: {
  ...
  auth: {
    ...
    usernamePlaceholder: "tu@esempio.com",
    ...
    signOut: "Esci",
    bullets: [
      "Un account — Atleta e Coach sono modalità della stessa sessione",
      "Feed, Ascend, TRAIN, Dashboard, Profilo — un sistema operativo",
      "Recupero solo dai tuoi dati. Non inventiamo mai HRV o sonno"
    ],
    demoBullets: [
  ...
  discover: {
    ...
    loading: "Caricamento anteprime editoriali…",
    matchCount: "{count} specialisti in questa anteprima editoriale corrispondono ai filtri",
  ...
  trainers: {
    ...
    subtitle:
      "Selezionati dal marketplace. Esperienza e retention sono pubblicate per profilo, mai come totale inventato.",
    seeAll: "Vedi tutti i coach"
  },
  testimonials: {
    ...
    steps: [
      {
        ...
        body: "Profilo in 60 secondi. Sport, livello, orari, modalità preferita. Mostriamo i tuoi 3 migliori match tra coach realmente elencati.",
  ...
  demos: {
    ...
    ctaBody: "Specialisti verificati nel marketplace. Intro gratuita di 15 min con ogni coach elencato.",
  ...
  methodologyPillars: [
    {
      ...
      citation: "Marketplace FitConnect. Totali roster non pubblicati finché non ci sono dati di produzione."
    },
    {
