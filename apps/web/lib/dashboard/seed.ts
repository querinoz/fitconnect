...
export const DEMO_ATHLETE_MARINA_ID = "a-marina";
...
export const initialDashboardState: DashboardState = {
  athletes: [
    ...
    {
      id: DEMO_ATHLETE_MARINA_ID,
      name: "Marina Costa",
      avatar: "https://i.pravatar.cc/200?img=5",
      sports: ["Yoga", "Climbing", "Running"],
      ...
      vo2max: 46.8,
      recoveryStatus: "green",
      goalTitle: "Lead 6b+ · sub-50 10K · handstand press",
      goalProgress: 58,
      streakWeeks: 6
    },
    {
  ...
  plans: [
    ...
    {
      id: "plan-marina-w20",
      athleteId: DEMO_ATHLETE_MARINA_ID,
      coachId: DEMO_COACH_MARINA_ID,
      weekLabel: "Week 20 · Multi-sport block",
      aiSuggestion:
        "Green readiness across yoga + climbing load. Keep Thursday intervals; swap Sunday long run to Z2 if sleep drops below 6.5h.",
      ...
      blocks: [
        {
          ...
          day: "Mon",
          title: "Vinyasa flow",
          detail: "45 min · hip openers + shoulder prep for climbing",
          intensity: "RPE 5",
          completed: true
        },
        {
          ...
          detail: "Project attempts · limit bouldering 4 problems",
          intensity: "RPE 8",
          completed: false
        },
        {
          ...
          day: "Fri",
          title: "Threshold intervals",
          detail: "5×3 min @ 10K pace · 90 s jog recovery",
          intensity: "Zone 4",
          completed: false
        },
        {
          ...
          day: "Sun",
          title: "Long run",
          detail: "12 km easy · last 2 km steady",
          intensity: "Z2",
          completed: false
        }
      ]
