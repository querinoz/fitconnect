...
export function MobileShell({
  ...
  return (
    <div className="fc-mobile-shell relative min-h-dvh w-full max-w-full overflow-x-clip bg-eos-floor text-eos-on-surface pb-[calc(96px+env(safe-area-inset-bottom))]">
      <div
        aria-hidden
