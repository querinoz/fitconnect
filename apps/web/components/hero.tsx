...
export function Hero() {
  ...
  const yImage = reduce ? 0 : yImageRaw;
  const yBlob = reduce ? 0 : yBlobRaw;
  ...
  return (
    ...
    >
      <div aria-hidden="true" className="absolute inset-0 -z-10 gradient-bg" />
      <motion.div
        aria-hidden="true"
        style={{ y: yBlob }}
      ...
      <div
        aria-hidden="true"
        className="absolute -bottom-32 -left-24 -z-10 h-[420px] w-[420px] rounded-full bg-accent-500/15 blur-3xl"
      />
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-12 items-center">
        ...
        >
          <motion.span
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: reduce ? 0 : 0.1, duration: reduce ? 0 : 0.5 }}
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" size="lg">
              <Link href="/methodology">{t("hero", "secondary")}</Link>
            </Button>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1 text-amber-400">
                  ...
                  <span className="ml-2 text-ink-100 font-semibold text-sm">
                    4.94
                  </span>
                </div>
                <p className="text-xs text-ink-400">{t("hero", "reviewsLine")}</p>
              </div>
            </div>
        ...
        >
          ...
          >
            <Search aria-hidden="true" className="h-4 w-4 text-brand-400" />
          ...
          >
            ...
            <p className="text-[11px] text-accent-400 font-semibold flex items-center gap-1">
              <Zap aria-hidden="true" className="h-3 w-3" /> Train hard today
            </p>
          </motion.div>
    ...
    >
      ...
      <div className="absolute inset-0 grid place-items-center">
        <div className="text-center">
          ...
          <p className="text-[9px] text-ink-400 uppercase tracking-widest">
            /100
          </p>
        </div>
      </div>
