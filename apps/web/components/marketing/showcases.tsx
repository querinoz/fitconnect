...
import { RealtimeBadge, SectionHeader } from "@/components/ui-glass/premium-system";
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        body="Filter, book, train. We&rsquo;ve obsessed over the friction in each step until they take seconds — not minutes."
        action={<RealtimeBadge>Product flows</RealtimeBadge>}
      />
