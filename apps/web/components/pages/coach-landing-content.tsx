        ...
        <div className="fc-marketing-container grid items-center gap-12 lg:grid-cols-2">
            <div>
              <SectionHeader
                ...
                body={cl.subtitle}
                action={<RealtimeBadge>Coach OS</RealtimeBadge>}
              />
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 max-w-md">
                <MetricTile label={cl.stats.activeCoaches} value="12,418" tone="brand" />
                <MetricTile label={cl.stats.avgTakeHome} value="85%" tone="volt" />
                <MetricTile label={cl.stats.coachNps} value="71" />
              </div>
            </div>
