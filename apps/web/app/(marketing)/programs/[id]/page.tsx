...
export default function ProgramDetailPage() {
  ...
  if (!program || !coach) {
    return (
      <main id="main" className="fc-marketing-hero fc-marketing-container pb-16 text-center">
    ...
    <main id="main" className="fc-marketing-hero fc-marketing-container pb-16">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10 grid gap-8 lg:grid-cols-3">
        ...
        <PremiumCard tone="plasma" className="p-6 space-y-4 h-fit">
          <h2 className="text-sm uppercase tracking-[0.18em] text-ink-400">Sample workout</h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-8">
        <h2 className="text-sm uppercase tracking-[0.18em] text-ink-400 mb-4">Athlete results</h2>
